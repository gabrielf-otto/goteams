...
import { getMembers, updateMember, inviteMember, removeMember } from './members';
...
export default function* rootSaga() {
   return yield all([
      ...
      takeLatest(AuthTypes.SIGN_IN_SUCCESS, getPermissions),
      takeLatest(AuthTypes.SIGN_IN_SUCCESS, getTeams),
      takeLatest(AuthTypes.SIGN_IN_SUCCESS, getProjects),
      ...
      takeLatest(MembersTypes.REMOVE_MEMBER_REQUEST, removeMember)
   ]);
}
